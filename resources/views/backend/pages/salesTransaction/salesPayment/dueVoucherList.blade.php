                    ...
                    <tbody>
                        ...
                        @foreach($dueVoucherList as $key => $eachResult)
                            @php
                               ...
                               $totalAmount =  helper::getSalesReturnAmount($eachResult->voucher_id);
                               $totalPayment = $totalAmount+$eachResult->totalPayment;
                                $pamount+=$eachResult->salesAmount;
                                $tpayment+=$eachResult->totalPayment+$totalAmount;
                                $damount+=$eachResult->dueAmount;
                                if($eachResult->dueAmount-$totalAmount > 0 ):
                            @endphp
                            <tr>
                                <td>{{$key+1}}</td>
                                ...
                                <td><input type="number"  name="total_payment[]"  readonly class="form-control totalPayment" value="{{$totalPayment ?? 0 }}"></td>
                                <td><input type="number"  name="due_amount[]"  readonly class="form-control dueAmount" value="{{$eachResult->dueAmount-$totalAmount}}"></td>
                                <td><input type="number"  name="credit[]"   class="form-control paymentNow decimal" value="{{$eachResult->dueAmount-$totalAmount}}"></td>
